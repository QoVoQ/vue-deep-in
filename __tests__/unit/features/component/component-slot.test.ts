import Vue, {renderFunction} from "src";
import {waitForUpdate, triggerEvent} from "src/shared/util";

describe("Component slot", () => {
  let vm, child;
  function mount(options: {
    childRenderFn: renderFunction;
    parentRenderFn?: renderFunction;
  }) {
    const parentFn =
      options.parentRenderFn ||
      function() {
        return [];
      };
    const childFn = options.childRenderFn;
    vm = new Vue({
      data: {
        msg: "parent message"
      },
      render(h) {
        return h("div", {}, [h("test", {}, [parentFn.call(this, h)])]);
      },
      components: {
        test: {
          render(h) {
            return childFn.call(this, h);
          },
          data() {
            return {
              msg: "child message"
  ...
  it("named slot", done => {
    mount({
      childRenderFn(h) {
        return h("div", {}, [this._t("test")]);
      },
      parentRenderFn(h) {
        return h("p", {slot: "test"}, [this.msg]);
      }
    });
    expect(child.$el.tagName).toBe("DIV");
    expect(child.$el.children[0].tagName).toBe("P");
  ...
  it("named slot with 0 as a number", done => {
    mount({
      childRenderFn(h) {
        return h("div", {}, [this._t("0")]);
      },
      parentRenderFn(h) {
        return h("p", {slot: 0}, [this.msg]);
      }
    });
    expect(child.$el.tagName).toBe("DIV");
    expect(child.$el.children[0].tagName).toBe("P");
  ...
  it("fallback content", () => {
    mount({
      childRenderFn(h) {
        return h("div", {}, [this._t("default", h("p", {}, [this.msg]))]);
      }
    });
    expect(child.$el.children[0].tagName).toBe("P");
  ...
  it("fallback content with multiple named slots", () => {
    mount({
      childRenderFn(h) {
        return h("div", {}, [
          this._t("a", h("p", {}, ["fallback a"])),
          this._t("b", h("p", {}, ["fallback b"]))
        ]);
      },
      parentRenderFn(h) {
        return h("p", {slot: "b"}, ["slot b"]);
      }
    });
  ...
  it("fallback content with mixed named/unnamed slots", () => {
    mount({
      childRenderFn(h) {
        return h("div", {}, [
          this._t("default", h("p", {}, ["fallback a"])),
          this._t("b", ["fallback b"])
        ]);
      },
      parentRenderFn(h) {
        return h("p", {slot: "b"}, ["slot b"]);
  ...
  it("default content should only render parts not selected", () => {
    mount({
      childRenderFn(h) {
        return h("div", {}, [this._t("a"), this._t("default"), this._t("b")]);
      },
      parentRenderFn(h) {
        return [
          h("div", {}, "foo"),
  ...
  it("name should only match direct children", function() {
    mount({
      childRenderFn(h) {
        return h("div", {}, [
          this._t("a", h("p", {}, "fallback a")),
          this._t("b", h("p", {}, "fallback b")),
          this._t("c", h("p", {}, "fallback c"))
        ]);
      },
      parentRenderFn(h) {
        return [
          h("p", {slot: "b"}, "select b"),
          h("span", {}, h("p", {slot: "b"}, "nested b")),
          h("span", {}, h("p", {slot: "c"}, "nested c"))
        ];
      }
    });
  ...
  it("slot inside v-if", done => {
    const vm: any = new Vue({
      ...
      render(h) {
        return h("test", {props: {show: this.show}}, [
          h("p", {slot: "b"}, this.b),
          h("p", {}, this.a)
        ]);
      },
      components: {
        test: {
          ...
          render(h) {
            return this.show
              ? h("div", {}, [this._t("default"), this._t("b")])
              : this._e();
          }
        }
      }
  ...
  it("nested slots", done => {
    const vm: any = new Vue({
      render(h) {
        return h("test", {}, [h("test2", {}, [h("p", {}, this.msg)])]);
      },
      data: {
        msg: "foo"
      },
  ...
  it("should not keep slot name when passed further down", () => {
    const vm = new Vue({
      render(h) {
        return h("test", {}, [h("span", {slot: "foo"}, "foo")]);
      },
      components: {
        test: {
          render(h) {
            return h("child", {}, [this._t("foo")]);
          },
          components: {
            child: {
              render(h) {
                return h("div", {}, [
                  h("div", {class: "default"}, [this._t("default")]),
                  h("div", {class: "named"}, [this._t("foo")])
                ]);
              }
            }
          }
  ...
  it("named slots should be consistent across re-renders", done => {
    const vm = new Vue({
      ...
      `,
      render(h) {
        return h("comp", {}, h("div", {slot: "foo"}, "foo"));
      },
      components: {
        comp: {
          data() {
          ...
          render(h) {
            return h("div", {}, [this._t("foo"), this.a]);
          }
        }
      }
    }).$mount();
    expect(vm.$el.textContent).toBe("foo1");
    (vm.$children[0] as any).a = 2;
    waitForUpdate(() => {
  ...
  it("should correctly re-create components in slot", done => {
    ...
    const vm = new Vue({
      ...
      `,
      render(h) {
        return h("comp", {}, [h("div", {slot: "foo"}, h("child"))]);
      },
      components: {
        comp: {
          data() {
          ...
          render(h) {
            return h("div", {}, [this.ok ? this._t("foo") : undefined]);
          }
        },
        child: {
    ...
    (vm.$children[0] as any).ok = false;
    waitForUpdate(() => {
      expect(calls).toEqual([1, 2]);
      (vm.$children[0] as any).ok = true;
    })
      .then(() => {
  ...
  it("should support duplicate slots", done => {
    const vm = new Vue({
      ...
      `,
      render(h) {
        return h("foo", {}, [h("div", {slot: "a"}, this.n)]);
      },
      data: {
        n: 1
      },
  ...
  it("events should not break when slot is toggled by v-if", done => {
    ...
    const vm = new Vue({
      ...
      render(h) {
        return h("test", {}, [
          h("div", {class: "click", on: {click: [this.test]}}, "hi")
        ]);
      },
      methods: {
        test: spy
      ...
      components: {
        test: {
          ...
          render(h) {
            return this.toggle ? h("div", {}, this._t("default")) : this._e();
          }
        }
      }
    }).$mount();
    ...
    (vm.$children[0] as any).toggle = false;
    waitForUpdate(() => {
      (vm.$children[0] as any).toggle = true;
    })
      .then(() => {
  ...
  it("slot of multiple text nodes should not be infinitely merged", done => {
    const wrap = {
      ...
      render(h) {
        return h("inner", {}, ["foo", this._t("default")]);
      },
      components: {
        inner: {
          data: () => ({a: 1}),
          ...
          render(h) {
            return h("div", {}, [this.a, this._t("default")]);
          }
        }
      }
    };
    ...
    (vm.$children[0].$children[0] as any).a++;
    waitForUpdate(() => {
  ...
  it("the elements of slot should be updated correctly", done => {
    const vm = new Vue({
      ...
      render(h) {
        return h("div", {}, [
          h("test", {}, [
            this._l(this.n, (item, idx) => h("span", {key: idx}, item)),
            h("input", {attrs: {value: "a"}})
          ])
        ]);
      },
      components: {
  ...
  //     render(h) {
  //       return h('div', {class:'bar'}, this._t('foo'))
  //     },
  //   };
